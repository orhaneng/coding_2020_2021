...
they must either all be chosen, or none of them chosen. For example, with the array {1, 2, 2, 2, 5, 2}, either
...
public class groupSumClump {
    ...
    public static void main(String[] args) {
        int[]  arr= new int[]{2, 4, 4, 8};
        int target = 14;
        System.out.println(groupSumClump(0, arr, target));
    }
