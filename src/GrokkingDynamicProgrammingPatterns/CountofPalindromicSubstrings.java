...
public class CountofPalindromicSubstrings {
    public static void main(String[] args) {
        System.out.println(CountofPalindromicSubstringsBottomupDynamicProgramming.countSubstrings("abdbca"));
    }
}

class CountofPalindromicSubstringsBottomupDynamicProgramming {
